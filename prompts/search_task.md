...
specified. Search produces a candidate list for the user to review; nothing
under `wiki/` is touched.
...
2. Tell the user the path of the candidate file and a one-line summary of what
   ...
   mostly secondary commentary rather than primary sources. Do not paste the
...
suggesting the user sharpen the direction or give a URL/arxiv id to ingest
directly.
